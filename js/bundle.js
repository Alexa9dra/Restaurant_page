...
function slider({sliderSelector, slideSelector, nextSelector, prevSelector}) {
    ...
    .then(data => {
        offers = data.data;
        document.querySelector('#total').textContent = (0,_timer__WEBPACK_IMPORTED_MODULE_0__.getZero)(offers.length);
    ...
    function setSlide() {
        document.querySelector('#current').textContent = (0,_timer__WEBPACK_IMPORTED_MODULE_0__.getZero)(slideIterator + 1);
